#!/bin/bash 
#===============================================================================
#          FILE: batch_settings.sh
#         USAGE: ./batch_settings.sh
#   DESCRIPTION: 
#       OPTIONS: ---
# 	LICENSE: AGPLv3+
#  REQUIREMENTS: ---
...
if ! [ -e /root/install/installed.ans ]; then
	...
	yum install -y kaltura-batch
	if [ $# -eq 0 ]; then
	   /opt/kaltura/bin/kaltura-batch-config.sh /root/install/default.config.ans
	else
        /opt/kaltura/bin/kaltura-batch-config.sh $1
	fi
